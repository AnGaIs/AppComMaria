...
import com.umservodemaria.appcommaria.api.weather.weatherClient;
import com.umservodemaria.appcommaria.api.weather.apiWeather;
import com.umservodemaria.appcommaria.config.Config;
import com.umservodemaria.appcommaria.entity.news.Category;
...
import com.umservodemaria.appcommaria.manager.BlurTransformation;
import com.umservodemaria.appcommaria.manager.GPSTracker;
import com.umservodemaria.appcommaria.manager.PrefManager;
import com.umservodemaria.appcommaria.services.AdsService;
import com.umservodemaria.appcommaria.ui.widget.NewAppWidget;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView mconsagracoes = (ImageView) findViewById(R.id.mconsagracoes);


        mconsagracoes.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,ConsagracaoActivity.class);
                startActivity(it);
            }
        });

        ImageView mnovenas = (ImageView) findViewById(R.id.mnovenas);


        mnovenas.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,NovenasActivity.class);
                startActivity(it);
            }
        });

        ImageView mcomuns = (ImageView) findViewById(R.id.mcomuns);


        mcomuns.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,ORAComunsActivity.class);
                startActivity(it);
            }
        });


        ImageView mespecificas = (ImageView) findViewById(R.id.mespecificas);


        mespecificas.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,EspecificasActivity.class);
                startActivity(it);
            }
        });


        ImageView msantos = (ImageView) findViewById(R.id.msantos);


        msantos.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,ProSantoActivity.class);
                startActivity(it);
            }
        });


        ImageView mmarianas = (ImageView) findViewById(R.id.mmarianas);


        mmarianas.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,MarianasActivity.class);
                startActivity(it);
            }
        });


        ImageView mterco = (ImageView) findViewById(R.id.mterco);


        mterco.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent it = new Intent(MainActivity.this,TercoActivity.class);
                startActivity(it);
            }
        });
    ...
    public boolean onNavigationItemSelected(android.view.MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.contact_us_action:
                ...
                break;
            case R.id.contact_us_action1:
                startActivity(new Intent(MainActivity.this,ContactActivity.class));
                break;
            case R.id.contact_us_action2:
                startActivity(new Intent(MainActivity.this,ContactActivity.class));
                break;
