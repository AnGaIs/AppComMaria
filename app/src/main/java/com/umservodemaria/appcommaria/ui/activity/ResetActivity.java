...
public class ResetActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id_user = intent.getStringExtra("PASSWORD_ID");
        key_user = intent.getStringExtra("PASSWORD_KEY");
    ...
    private void initView(){
        ...
        this.cpassword_input_password.addTextChangedListener(new ResetActivity.PasswordTextWatcher(cpassword_input_password));
        this.cpassword_input_password_confirm.addTextChangedListener(new ResetActivity.PasswordTextWatcher(cpassword_input_password_confirm));
    }
    ...
    private void submitForm() {
        ...
        Call<ApiResponse> call = service.reset(id_user,key_user,cpassword_input_password.getText().toString());
